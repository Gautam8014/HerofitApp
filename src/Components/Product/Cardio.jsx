...
return ()=> clearTimeout(debounceFn);
  ...
  const getData= async ()=>{
    ...
    let res= await axios.get(`https://fitserver-n60z.onrender.com/cardio?q=${search}`)
...
useEffect(() => {
  ...
  const fetchProductData = async () => {
    let url=`https://fitserver-n60z.onrender.com/cardio?_page=${page}&_limit=9`
    // if(sort==="high"){
...
<div>
      <Input color='white' placeholder='Search by name'
        type="text"
